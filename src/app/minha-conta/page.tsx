...
import { User, Calendar, MessageSquare, Star, Layers, Upload } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2 space-y-4">
          <div className="grid grid-cols-3 gap-4">
            {[
              { icon: Layers, label: 'Peças enviadas', value: 0, href: '/minha-conta/pecas' },
              { icon: MessageSquare, label: 'Comentários', value: 0, href: '#' },
              { icon: Star, label: 'Avaliações', value: 0, href: '#' },
            ].map((stat) => (
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            ...
            <div className="space-y-2">
              <Link href="/enviar" className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                <div className="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center"><Upload size={16} className="text-blue-600" /></div>
